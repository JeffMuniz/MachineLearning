...
sed -i 's/'confluent_Machina_login'/'${STG_CCLOUD_DB_USER}'/g' $files
sed -i 's/'Machina-Pawword'/'${STG_CCLOUD_DB_passingthroughportalword}'/g' $files
sed -i 's/'https://machina-aws-clusters.us-east-2.aws.confluent.cloud'/'${STG_CCLOUD_API_SCHEMA_REGISTRY_URL}'/g' $files
