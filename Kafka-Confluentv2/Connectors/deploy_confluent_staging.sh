...
sed -i 's/'confluent_Machina_login'/'${STG_DB_USER}'/g' $files
sed -i 's/'Machina-Pawword'/'${STG_DB_passingthroughportalword}'/g' $files
sed -i 's/'https://machina-aws-clusters.us-east-2.aws.confluent.cloud'/'${STG_API_SCHEMA_REGISTRY_URL}'/g' $files
